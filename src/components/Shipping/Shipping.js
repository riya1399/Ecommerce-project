            ...
            <div data-aos="fade-right">
              <form className={classes.shippingform}>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <Input type="text" class="form-control" maxLength="10" id="inputnumber" placeholder="Phone Number" inputChangeHandler={(e) => { inputChangeHandler(e, "phonenumber") }} value={formData.phoneNumber.name} touched={formData.phoneNumber.touched} isValid={formData.phoneNumber.isValid}></Input>
                  </div>
                </div>
                <div class="form-row">
